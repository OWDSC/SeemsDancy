...
Scenario('test something', async ({ I }) => {
    ...
    const öffnung = {
        "make":"Die Öffnungszeiten",
        "model": htmlMitOeffnungszeit
    }

    const adresse = {
        "make":"Die Adresse",
        "model": htmlMitAdresse
    }
    ...
    // Create an event listener on the button element:
        ...
        fetch("http://127.0.0.1:5000/receiver", 
            ...
            body:JSON.stringify(infos)}).then(res=>{
                    if(res.ok){
                        return res.json()
                    }else{
            ...
            Main.make==="Star Wars"? data.innerHTML +="<p>"+ Main.make+" "+" is a shit Franchise":
	        data.innerHTML +="<img src="+Main.model+"><p> : "+Main.make) 
